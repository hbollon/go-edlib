...
func TestStringsSimilarity(t *testing.T) {
	...
	tests := []struct {
		...
		/*
			...
			{"Qgram : MARTHA/MARHTA", args{"MARTHA", "MARHTA", Qgram}, 0.4, false},
			{"Qgram : DIXON/DICKSONX", args{"DIXON", "DICKSONX", Qgram}, 0.36363637, false},
			{"Qgram Sentence 1", args{"Radiohead", "Radiohead", Qgram}, 0.0, false},
			{"Qgram Sentence 2", args{"ABCD", "ABCE", Qgram}, 2.0, false},
			{"Qgram Sentence 3", args{"Radiohead", "Carly Rae Jepsen", Qgram}, 21.0, false},
			{"Qgram Sentence 4", args{"I love horror movies", "Lights out is a horror movie", Qgram}, 22.0, false},
			{"Qgram Sentence 5", args{"love horror movies", "Lights out horror movie", Qgram}, 15.0, false},
			{"Qgram Sentence 6", args{"私の名前はジョンです", "私の名前はジョン・ドゥです", Qgram}, 5, false},
			{"Qgram Sentence 7", args{"🙂😄🙂😄 😄🙂😄", "🙂😄🙂😄 😄🙂😄 🙂😄🙂", Qgram}, 4, false},
			{"Qgram Sentence 8", args{"", "", Qgram}, 0.0, false},
		*/
